  ...
  <body>
    ...
    <nav class="navbar navbar-light bg-dark">
        <div class="container ">
           ...
           <div class="offset-4 text-light fs-2">
              <h2>
                  Inventory Management System
              </h2>
            </div>
        </div>
        <a href="html/loginpage.php" class="btn btn-primary btn-lg " tabindex="-1" role="button" >Login</a>
    </nav>
    ...
    <div class="pt-5 bg-secondary text-light ht"> 
      <div>
        ...
        <br><br>
      <div>
        <h4 class="fw-bold text-center">Why do we need it?</h4><br>
        <div class="mx-5">
